       ...
       printf("1. Lancer une nouvelle partie\n");
        ...
        switch(choix)
        {
            ...
            case 4:
            {
                ...
                printf("Si un joueur qui passe le départ sur le jet d un de atterit 2 cases apres coffre de communaute\n");
                ...
                printf("majore d un interet de 10%. Si le proprietaire vend cette propriete a un autre joueur, l acheteur doit\n");
                printf("payer le montant de l hypotheque et payer un interet de 10% additionnel a la Banque.\n");
                printf("S il leve l hypotheque plus tard, il doit payer un interet de 10% lors de son achat, puis\n");
                printf("le montant de l hypotheque et les 10% lors de la levee de l hypotheque\n");
                ...
                printf("S il a hypotheque un bien, le creancier doit payer immediatement 10% de la valeur du bien.\n");
